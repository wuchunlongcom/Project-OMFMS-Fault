#-*- coding: utf-8 -*-
#from django.core.urlresolvers import reverse # 1.11.5
from django.urls import reverse # 2.2.6
...
from accounts.models import Contact,MyUser
...
def contact_list(request):
    ...
    return render(request, 'accounts/contact.html', data)
