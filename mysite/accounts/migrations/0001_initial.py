# -*- coding: utf-8 -*-
# Generated by Django 1.11.5 on 2020-03-09 01:11
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_of_birth', models.DateField(blank=True, null=True, verbose_name='日期')),
                ('is_active', models.BooleanField(default=True)),
                ('is_admin', models.BooleanField(default=False)),
                ('groups', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='auth.Group', verbose_name='组')),
            ],
            options={
                'verbose_name': '用户',
