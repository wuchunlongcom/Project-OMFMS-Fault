...
urlpatterns = [
    ...
    #User Managment
    url(r'^user/$', views.accounts_user,name='user_user'),
    url(r'^user/add/$', views.accounts_add,name='user_add'),
    url(r'^user/edit/$', views.accounts_edit,name='user_edit'),
    url(r'^user/del/$', views.accounts_del,name='user_del'),
